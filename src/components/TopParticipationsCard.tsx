...
const medalColors: Record<number, { border: string }> = {
  0: {
    border: "border-l-4 border-l-gold",
  },
  1: {
    border: "border-l-4 border-l-silver",
  },
  2: {
    border: "border-l-4 border-l-bronze",
  },
};
          ...
          return (
            <motion.div
              ...
              className={`flex items-center gap-3 rounded-lg p-3 ${
                isTop3 ? ` bg-background ${medal?.border}` : "bg-background"
              }`}
            >
              <span
